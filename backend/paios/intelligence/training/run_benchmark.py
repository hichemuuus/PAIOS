...
Usage:
    python -m paios.intelligence.training.run_benchmark
"""
...
from paios.intelligence.training.benchmark_v2 import BenchmarkV2, BenchmarkReportV2
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run PAIOS v2 benchmark")
    parser.add_argument(
        "--dataset",
        type=str,
        default=None,
