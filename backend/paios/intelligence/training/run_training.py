...
Usage:
    python -m paios.intelligence.training.run_training
"""
...
def run_training(output_dir: str | Path | None = None) -> dict[str, Any]:
    ...
    """
    logger.info("=" * 60)
    logger.info("PAIOS v2 Training Pipeline")
    logger.info("=" * 60)
    ...
    if not SYNTHETIC_DATA_PATH.is_file():
        raise FileNotFoundError(
            ...
            f"Run `python -m paios.intelligence.training.generate_dataset` first."
        )
