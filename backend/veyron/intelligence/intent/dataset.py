...
from veyron.llm.micro.router import INTENT_CATEGORIES
...
_SEED_QUERIES: dict[str, list[str]] = {
    ...
    "file_operation": [
        ...
        "Count the number of lines in backend/veyron/__init__.py",
...
_BENCHMARK_VARIANTS: dict[str, list[str]] = {
    "file_operation": [
        "List all files in the current directory",
        "What is the size of the file at backend/veyron/__init__.py?",
    ],
    "system_management": [
    ...
    "planning_task": [
        "Read the file backend/veyron/__init__.py and tell me what version it says",
