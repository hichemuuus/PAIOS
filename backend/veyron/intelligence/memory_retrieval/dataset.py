...
from veyron.intelligence.memory_retrieval.schema import MemoryRetrievalExample
...
#
# Categories mirror ``veyron.db.models.MemoryCategory`` (USER, PROJECT, HISTORY,
...
_SEED_CLUSTERS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "memories": [
            "User's main repository is EARTH-1/Veyron; default branch is main; feature branches use phase-N naming.",
            ...
            "User runs the stack with uvicorn behind systemd; logs go to journald and are tailed with journalctl -u veyron.",
        ],
    },
]
