    ...
    def generate_seed(cls) -> ToolSelectionDataset:
        ...
        if has_tool.get("filesystem_read", False):
            examples.extend([
                ...
                ToolSelectionExample(text="What is the size of backend/veyron/__init__.py?", expected_tools=["filesystem_read"], intent_category="file_operation", notes="needs file_path and action=stat"),
