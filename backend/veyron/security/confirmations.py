...
class ConfirmationManager:
    ...
    async def respond(self, confirmation_id: str, *, approved: bool, reason: str | None = None) -> bool:
    ...
    async def _respond(
        self, confirmation_id: str, *, approved: bool, reason: str | None, timed_out: bool = False
    ) -> bool:
